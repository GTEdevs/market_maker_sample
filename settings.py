...
# API URL BASE
API_URL_BASE = "api.gte.io" # 外网访问上海内网
WS_URL = "wss://td.gte.io"

# The GTE API requires permanent API keys. 
# 外网    
#API_KEY = "mTCemQTEgxxslsyoutnegFfn"
#API_SECRET = "fpVuaRncXaPtpjpSVEHtjYwRaiFzkgBIxDfUysVjOsaMcFYVHcNSlJxoYRfntKXd"

# 内网
API_KEY = "PNEsWEDhwvsNVkfZIBsRIoAv"
API_SECRET = "WpcBcZMduJIyYldMGjSHWFauMNqlvVyJCGBHSuEAEovsVPzkpAGSfRisLazPbcTP"


########################################################################################################################
# Target
########################################################################################################################
# settlement currency to market make on GTE.
SETTLECURRENCY = "BTC"

# Instrument type to market make on GTE.
