...
def run():
    parser = argparse.ArgumentParser(description='sample GTE market maker')
    parser.add_argument('command', nargs='?', help='Instrument symbol on GTE or "setup" for first-time config')
